...
def get_args():
    ...
    parser.add_argument('--chain', type=str, default='bnb')
    ...
    parser.add_argument('--exclude_classes', type=int, nargs='+', default=['n'], help='Classes to exclude from the dataset for multiclass classification')
