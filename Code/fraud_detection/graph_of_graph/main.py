...
def main():
    ...
    model_params = {
        'DOMINANT': [{'hid_dim': d, 'lr': lr, 'epoch': e} for d in [16, 32, 64, 128] for lr in [0.01, 0.005, 0.1] for e in [50, 100, 150, 200]],
        'DONE': [{'hid_dim': d, 'lr': lr, 'epoch': e} for d in [16, 32, 64, 128] for lr in [0.01, 0.005, 0.1] for e in [50, 100, 150, 200]],
        'GAE': [{'hid_dim': d, 'lr': lr, 'epoch': e} for d in [8, 16, 32, 64, 128] for lr in [0.01, 0.005, 0.1] for e in [50, 100, 150]],
        'AnomalyDAE': [{'hid_dim': d, 'lr': lr, 'epoch': e} for d in [16, 32, 64, 128] for lr in [0.01, 0.005, 0.1] for e in [50, 100, 200]],
        'CoLA': [{'hid_dim': d, 'lr': lr, 'epoch': e} for d in [16, 32, 64, 128] for lr in [0.01, 0.005, 0.1] for e in [50, 100, 150]]
    }
